...
- The public external intake endpoint is rate-limited per mailbox, token, and client IP before import work is started. Limited responses return `429`, `Retry-After`, and `X-RateLimit-*` headers.
