...
- The public external intake endpoint is rate-limited per mailbox and client IP before import work is started. Limited responses return `429`, `Retry-After`, and `X-RateLimit-*` headers, and rotating invalid tokens does not bypass the limit.
