...
import type { RoutineEnvConfig, RoutineRevisionSnapshotV1, RoutineTriggerConditions, RoutineVariable } from "@paperclipai/shared";
...
export const routineTriggers = pgTable(
  "routine_triggers",
  {
    ...
    minTimeOfDayMin: integer("min_time_of_day_min"),
    maxTimeOfDayMin: integer("max_time_of_day_min"),
    minDaysAhead: integer("min_days_ahead"),
