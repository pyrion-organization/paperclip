...
export const companies = pgTable(
  "companies",
  {
    ...
    emailTemplateBrandName: text("email_template_brand_name"),
    emailTemplateTagline: text("email_template_tagline"),
    emailTemplateWebsiteUrl: text("email_template_website_url"),
