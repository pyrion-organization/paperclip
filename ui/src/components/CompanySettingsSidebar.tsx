...
import { ChevronLeft, CloudUpload, KeyRound, Mail, MailPlus, MonitorCog, Puzzle, Settings, SlidersHorizontal, Users } from "lucide-react";
...
export function CompanySettingsSidebar() {
  ...
  return (
    <aside className="size-full min-h-0 border-r border-border bg-background flex flex-col">
      ...
      <nav className="flex-1 min-h-0 overflow-y-auto scrollbar-auto-hide px-3 py-2">
        <div className="flex flex-col gap-0.5">
          ...
          <SidebarNavItem to="/company/settings/email" label="Email" icon={Mail} end />
          <SidebarNavItem
          ...
          />
          {companySettingsPluginSlots.flatMap((slot) => (slot.routePath) ? [(
              <SidebarNavItem
