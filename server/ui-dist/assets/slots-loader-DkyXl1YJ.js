const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-CNsrgUjg.css"])))=>i.map(i=>d[i]);
import{_ as k,H as w}from"./index-9jALgWXB.js";import{registerPluginReactComponent as K,registerPluginWebComponent as T,clearPluginComponentRegistry as $}from"./slots-registry-Cy4YZiJy.js";import"./sidebar-runtime-D57EFm4H.js";const c=new Map,u=new Map,d={};let S=null;function f(e){const t=e.updatedAt??e.version??"0";return`${e.pluginId}:${t}`}function B(e){const t=encodeURIComponent(e.updatedAt??e.version??"0");return`/_plugins/${encodeURIComponent(e.pluginId)}/ui/${e.uiEntryFile}?v=${t}`}function R(e,t){return t===void 0?e??{}:{...e??{},key:t}}function h(e){return`
