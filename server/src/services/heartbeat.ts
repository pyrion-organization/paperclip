...
export function heartbeatService(db: Db, options: HeartbeatServiceOptions = {}) {
  ...
  async function claimQueuedRun(run: typeof heartbeatRuns.$inferSelect) {
    ...
    const claimedWakeReason = readNonEmptyString(claimedContextSnapshot.wakeReason);
    if (claimedIssueId && !suppressIssueExecutionLock && claimedWakeReason !== "source_scoped_recovery_action") {
